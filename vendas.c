...
char tela_vendas(void) {
    ...
    printf("///            2. PESQUISAR venda efetivada                                 ///\n");
    printf("///            3. CANCELAR venda efetivada                                  ///\n");
...
void realizar_venda(void) {
    ...
    printf("///           ===================================================           ///\n");
    printf("///                                                                         ///\n");
    printf("///            Digite o nome ou codigo do produto:                          ///\n");
    printf("///            Digite a quantidade:                                         ///\n");
    printf("///                                                                         ///\n");
    printf("///            Pensar mais sobre - em desenvolvimento                       ///\n");
    printf("///                                                                         ///\n");
    printf("///////////////////////////////////////////////////////////////////////////////\n");
    printf("\n");
...
void pesquisar_venda(void) {
    ...
    printf("///           ===================================================           ///\n");
    printf("///                                                                         ///\n");
    printf("///            Informe o numero do cupom da venda:                          ///\n");
    printf("///                                                                         ///\n");
    printf("///                                                                         ///\n");
    printf("///////////////////////////////////////////////////////////////////////////////\n");
    printf("\n");
